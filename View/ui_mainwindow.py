...
################################################################################
## Form generated from reading UI file 'mainwindowFOQmTV.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.groupBox_servo_start, 3, 0, 1, 4)
        ...
        self.gridLayout.addWidget(self.groupBox_magneto_start, 4, 0, 1, 4)
        ...
        self.gridLayout.addWidget(self.label_time_start, 2, 0, 1, 1)

        self.timeEdit_time_start = QTimeEdit(self.start_of_day)
        self.timeEdit_time_start.setObjectName(u"timeEdit_time_start")

        self.gridLayout.addWidget(self.timeEdit_time_start, 2, 1, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.groupBox_megneto_end, 4, 0, 1, 4)
        ...
        self.gridLayout_4.addWidget(self.servo_end, 3, 0, 1, 4)
        ...
        self.gridLayout_4.addWidget(self.label_time_end, 2, 0, 1, 1)

        self.timeEdit_time_end = QTimeEdit(self.end_of_day)
        self.timeEdit_time_end.setObjectName(u"timeEdit_time_end")

        self.gridLayout_4.addWidget(self.timeEdit_time_end, 2, 1, 1, 1)
